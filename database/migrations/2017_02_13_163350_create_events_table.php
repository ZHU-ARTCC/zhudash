...
class CreateEventsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Events", 'events', 'event_name', 'fa-plane', [
            ["banner", "Banner Link", "TextField", false, "", 0, 256, false],
            ["event_name", "Event Name", "String", false, "", 0, 256, true],
            ["airports", "Focus Airfield(s)", "String", false, "", 0, 256, true],

...
class CreateSopsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Sops", 'sops', 'name', 'fa-file-pdf-o', [
            ["name", "SOP Name", "String", false, "", 0, 256, true],
            ["file", "File", "URL", false, "", 0, 256, true],
            ["updated_by", "Updated By", "Name", false, "", 0, 256, true],
        ]);

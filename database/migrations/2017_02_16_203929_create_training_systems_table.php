...
class CreateTrainingSystemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Training_systems", 'training_systems', 'ctl_name', 'fa-graduation-cap', [

			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'event_name')
						@la_display($module, 'airports')
						@la_display($module, 'time-start')
						@la_display($module, 'time-end')
						@la_display($module, 'description')
						@la_display($module, 'positions')
						@la_display($module, 'vatusa_link')
						@la_display($module, 'active')
						@la_display($module, 'line-up')
					</div>
				</div>
			</div>
		</div>

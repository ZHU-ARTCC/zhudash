		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="box-body">
					...
					@la_input($module, 'event_name')
					@la_input($module, 'airports')
					@la_input($module, 'time-start')
					@la_input($module, 'time-end')
					@la_input($module, 'description')
					@la_input($module, 'positions')
					@la_input($module, 'vatusa_link')
					@la_input($module, 'active')
					@la_input($module, 'line-up')
					--}}
				</div>
			</div>

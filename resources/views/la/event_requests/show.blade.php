...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $event_request->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Event_Requests", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/event_requests/'.$event_request->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Event_Requests", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.event_requests.destroy', $event_request->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/event_requests') }}" data-toggle="tooltip" data-placement="right" title="Back to Event Requests"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'ctl_name')
						@la_display($module, 'event_request')
						@la_display($module, 'position_request')

...
<center>
    <div class="col-md-8 title-info">
        ...
        <h1 class="subject-header">Your Training Request is Pending</h1>
    </div>
</center>
...
<div class="col-md-8 body">
    ...
    Your request for training at the Houston Virtual ARTCC is now pending, with the following information:<br><br>

    Position: {{$airport}} {{$position}}<br>
    Date: {{$date}}<br>
    Duration: {{$start}} - {{$end}}<br><br>

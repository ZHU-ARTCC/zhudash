...
<center>
    <div class="col-md-8 title-info">
        ...
        <h1 class="subject-header">Feedback Submission</h1>
    </div>
</center>
...
<div class="col-md-8 body">
    ...
    A pilot has submitted feedback via the feedback form. The infomation is as follows:<br><br>
    
    Pilot Name: {{$name}} ({{$cid}})<br>
    Pilot Email: {{$email}}<br>
    --<br>
    Controller Name: {{$ctl_name}}<br>
